	...
	_: {
		...
		routes: [
			...
			},
			{
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('../output/server/entries/endpoints/api/movie/tmdb/embeds/_server.ts.js'))
			},
			{
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('../output/server/entries/endpoints/api/tv/tmdb/embeds/_server.ts.js'))
			},
			{
				id: "/home",
				pattern: /^\/home\/?$/,
