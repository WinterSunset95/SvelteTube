import type { TMDBitem, TMDBresult, TmdbTv, TMDBMovieInfo, TmdbTvInfo  } from "./types"
import { type ISearch, type IMovieResult, type IMovieInfo, TvType, MediaStatus } from "@consumet/extensions"
...
export function tmdbTvToConsumet(content: TMDBresult<TmdbTv>): ISearch<IMovieResult> {
	let data: ISearch<IMovieResult> = {
		results: [],
		totalPages: 0,
		totalResults: 0
